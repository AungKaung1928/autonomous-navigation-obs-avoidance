#!/usr/bin/env python3
"""TurtleBot3 burger + patrol controller in Gazebo Harmonic (gz-sim 8) via ros_gz.
...
def generate_launch_description():
    ...
    declared = [
        ...
        DeclareLaunchArgument(
            'world',
            default_value=os.path.join(pkg_dir, 'worlds', 'turtlebot3_world.sdf'),
        ...
        DeclareLaunchArgument(
            ...
            description='Patrol controller parameter file'),
    ]
    ...
    patrol = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_dir, 'launch', 'patrol_robot.launch.py')),
    ...
    return LaunchDescription(declared + [
        ...
        TimerAction(period=8.0, actions=[patrol]),
    ])
